...
function visualization(theData) {
  ...
  var toolTip = d3
    ...
    .html(function(d){
      var theX;
      // grab the state name
      var theState = "<div>" + "<b>" + d.state + "</b></div>"
  ...
  var stateCircles = svg.selectAll("g stateCircle").data(theData).enter();
  ...
  stateCircles 
    ...
    .on("mouseout", function(d) {
      ...
      toolTip.hide(d);
      d3.select(this).style("stroke","#e3e3e3").style("stroke-width", 3);
    });
  ...
  stateCircles
    ...
    .on("mouseover", function(d) {
      toolTip.show(d);
      d3.select("." + d.abbr).style("stroke", "red").style("stroke-width", 3);
    })
    .on("mouseout", function(d) {
      toolTip.hide(d);
      d3.select("." + d.abbr).style("stroke", "#e3e3e3").style("stroke-width", 3);
    });
